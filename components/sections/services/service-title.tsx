...
export default function ServiceTitle(props: Props) {
  return (
    <div className="bg-primary text-primary-foreground">
      <div className="px-6 lg:px-12 pt-36 pb-20 lg:pb-36 lg:pt-40 max-w-[1280px] mx-auto">
        <div className="lg:flex justify-between items-center gap-32">
          <div className="w-full md:w-3/4 lg:w-1/2">
            ...
            <div className="py-3" />
            <h1 className="text-5xl lg:text-7xl font-medium leading-[1.1] overflow-y-hidden">
              {props.title}
            </h1>
            <div className="py-4" />
